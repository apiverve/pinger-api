    ...
    class DomainandIPPingerExample
    {
        ...
        static async Task<JsonDocument> CallDomainandIPPingerAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { host &#x3D; &quot;google.com&quot;, retries &#x3D; 1 };
        ...
        {
            Console.WriteLine("📤 Calling Domain and IP Pinger API...\n");

            var result = await CallDomainandIPPingerAPI();
