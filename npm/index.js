...
class pingerWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/pinger');
        }
        ...
        this.validationRules = {"host":{"type":"string","required":true},"timeout":{"type":"integer","required":false,"min":100,"max":3000,"default":1500},"retries":{"type":"integer","required":false,"min":1,"max":5,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/pinger`);
        }
    }
