# Domain and IP Pinger Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:pinger-api:1.1.14'
}
```
...
```java
import com.apiverve.pinger.DomainandIPPingerAPIClient;
import com.apiverve.pinger.APIResponse;
import com.apiverve.pinger.APIException;

// Initialize the client
DomainandIPPingerAPIClient client = new DomainandIPPingerAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("host", "google.com");
    parameters.put("timeout", 1500);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/pinger](https://docs.apiverve.com/ref/pinger)
...
- **Documentation:** [https://docs.apiverve.com/ref/pinger](https://docs.apiverve.com/ref/pinger)
- **Issues:** [GitHub Issues](https://github.com/apiverve/pinger-api/issues)
